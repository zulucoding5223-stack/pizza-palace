  ...
  return (
    <div className="pt-24 px-10">
      ...
      <div className="md:hidden">
              ...
              >
                ...
                <div className="flex items-center gap-3 w-full justify-around">
                  {item.sizes.map((size) => {
                    ...
                    return (
                      <div className="flex items-start flex-col gap-1 bg-gray-200 p-3 rounded-lg text-[0.70rem]">
                ...
                <div className="flex items-center w-full justify-between gap-2">
                  <button className="text-[0.85rem] w-full pb-0.75 pt-0.5 rounded-lg text-white bg-blue-500 hover:cursor-pointer hover:bg-blue-700">
                    Edit
                  </button>
        ...
        <button className="w-full bg-orange-500 text-white hover:bg-orange-700 text-[0.85rem] pb-0.75 pt-0.5 rounded-lg mt-3 whitespace-nowrap">
          Clear Cart
        </button>
      </div>
      <div>
                    ...
                    >
                      ...
                      <td className="px-4 py-3">
                        <div className="flex flex-col gap-1">
                          {item.sizes.map((size, index) => (
                            ...
                            >
                              Size {size.size} • Qty {size.quantity} • R
                      ...
                      <td className="px-4 py-3">
                        <div className="flex justify-center gap-2">
                          <button className="px-3 py-1 bg-blue-500 text-white rounded-md text-xs hover:bg-blue-700 whitespace-nowrap">
                            Edit
                          </button>
